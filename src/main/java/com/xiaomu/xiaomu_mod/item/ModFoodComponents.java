...
public class ModFoodComponents {
    ...
    public static final FoodComponent GILDED_BREAD = new FoodComponent.Builder().nutrition(7).saturationModifier(1.2f)
            .build();

    public static final FoodComponent GOLDEN_BREAD = new FoodComponent.Builder().nutrition(7).saturationModifier(0.8F)
            .statusEffect(new StatusEffectInstance(StatusEffects.REGENERATION, 100, 1), 1.0F)
    ...
    public static final FoodComponent ENCHANTED_GOLDEN_BREAD = new FoodComponent.Builder().nutrition(8).saturationModifier(1.2F)
